...
public class BetPlacePageForTurbo2Split extends TestBase {
	GamePage gamePage;
	...
	//Select Bet Type
		...
		By betType = By.xpath("//a[contains(text()," + betName18+")]");
	...
	public BetPlacePageForTurbo2Split() {
