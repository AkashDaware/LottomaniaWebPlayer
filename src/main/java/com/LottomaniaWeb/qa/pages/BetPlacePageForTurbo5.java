...
public class BetPlacePageForTurbo5 extends TestBase {
	GamePage gamePage;
	...
	//Select Bet Type
		...
		By betType = By.xpath("//a[contains(text()," + betName15+")]");
