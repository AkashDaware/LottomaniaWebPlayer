...
public class BetPlacePageForTurbo3 extends TestBase {
	GamePage gamePage;
	...
	//Select Bet Type
		...
		By betType = By.xpath("//a[contains(text()," + betName13+")]");
