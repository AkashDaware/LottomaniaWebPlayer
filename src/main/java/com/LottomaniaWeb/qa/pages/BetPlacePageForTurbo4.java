...
public class BetPlacePageForTurbo4 extends TestBase {
	GamePage gamePage;
	...
	//Select Bet Type
		...
		By betType = By.xpath("//a[contains(text()," + betName14+")]");
